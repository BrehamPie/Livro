...
if($todo == 'login'){
    ...
    $sql = "SELECT COUNT(*) as cnt FROM user WHERE email = '$emailId'";
    $res = myquery($sql);
    ...
    insertUser($username,$emailId,$hashed_password);
    insertActivity(0,getLastID('user'),1);
    $ar['problem'] = 'reg-ok';
    $jsonData=json_encode($ar);
    echo $jsonData;
}